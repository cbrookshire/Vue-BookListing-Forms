  ...
  <form v-on:submit.prevent="bookSubmit(bookData)" class="" action="#" method="post">
    ...
    <div>
      <label for="finishedReading">
        Finished Reading
        <input v-model="bookData.finishedReading" type="checkbox" name="bookData" value="" placeholder="Finished Books">
      </label>        
    </div>
    <div>
      <label for="borrowed">
        Borrowed
        <input v-model="bookData.ownership" type="radio" name="borrowed" value="" placeholder="Borrowed">
      </label>
      <label for="bought">
        Bought
        <input v-model="bookData.ownership" type="radio" name="bought" value="" placeholder="Bought">
      </label>
    </div>
